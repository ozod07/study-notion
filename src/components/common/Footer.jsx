...
const Footer = () => {
  return (
    <div className='bg-richblack-800 mx-7 rounded-3xl mb-10'>
        ...
        >
            <div className='w-[100%] border-b flex flex-col lg:flex-row pb-5 border-richblack-500'>
            ...
            <div className='flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full'>
                <div className='flex'>
                    {BottomFooter.map((ele, index) => {
                        return(
                            <div
                                key={index}
                                className={`${BottomFooter.length - 1 === index ? "" : "border-r border-richblack-700" }
                ...
                <div className='text-center flex flex-col sm:flex-row'>
                    <div className='flex'>
                        ...
                        <Link to={''} className='text-white hover:underline mr-1'>Ozodbek</Link>
                ...
                <div className='flex items-center'>
                    <a href='/' className='text-white p-3 hover:bg-richblack-700 rounded-full duration-300' target='_blank'>
                        <ImLinkedin2 size={17}/>
                    </a>
                    <a href='/' className='text-white p-3 hover:bg-richblack-700 rounded-full duration-300' target='_blank'>
                        <ImGithub size={17}/>

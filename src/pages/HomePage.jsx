...
import InctructorSection from '../components/core/Home/InctructorSection'
    ...
    <React.Fragment>
      <div>
        <div className='w-full  h-[450px] md:h-[650px] absolute top-0 left-0 opacity-[0.3] overflow-hidden object-cover'>
          <img className='w-full h-full object-cover' src={backgroundImg} alt='Background'/>
          ...
          <div className='relative h-[450px] md:h-[550px] justify-center mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white '>
            <Link to='signup'>
              <div className='z-0 group p-1 mx-auto rounded-full bg-richblack-800 font-bold text-richblack-200
                  transition-all duration-200 hover:scale-110 w-fit'>
      ...
      >
        ...
        <div className='relative mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white justify-between'>
          ...
          <div className='mx-auto box-content w-full max-w-maxContentTab  py-12 lg:max-w-maxContent'>
              <h2 className='text-white text-2xl mb-6'>Popular Picks for You 🏆</h2>
          ...
          <div className='mx-auto box-content w-full max-w-maxContentTab  py-12 lg:max-w-maxContent'>
              <h2 className='text-white text-2xl mb-6'>Top Enrollments Today 🔥</h2>
              <div className='flex gap-7'>
                <Course_Card />
                <Course_Card />
                <Course_Card />
          ...
          <div className='mx-auto box-content w-full max-w-maxContentTab  py-12 lg:max-w-maxContent'>
              <h2 className='text-white text-2xl mb-6'>All Courses</h2>
              <div className='flex gap-7'>
                <Course_Card />
                <Course_Card />
                <Course_Card />
        ...
        <div className='bg-pure-greys-5 text-richblack-700'>
              ...
              <div className='mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-7'>
                  <di className='flex flex-col lg:flex-row gap-5 mb-10 mt-[95px]'>
        ...
        <div className='mt-14 w-11/12 mx-auto max-w-maxContent flex-col items-center justify-between gap-8 
